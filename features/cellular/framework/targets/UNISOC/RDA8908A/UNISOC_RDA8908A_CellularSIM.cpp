...
UNISOC_RDA8908A_CellularSIM::UNISOC_RDA8908A_CellularSIM(ATHandler &atHandler) : AT_CellularSIM(atHandler)
{

}

UNISOC_RDA8908A_CellularSIM::~UNISOC_RDA8908A_CellularSIM()
{

}

nsapi_error_t UNISOC_RDA8908A_CellularSIM::get_sim_state(SimState &state)
{
    char buf[13];
